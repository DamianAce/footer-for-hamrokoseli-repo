...
<body class="bg-[#F4EAE1] text-brand-dark font-sans leading-relaxed">
    ...
    <section
        ...
        style="background-image: url('Assets/1st image.png');">
        ...
        <div class="container mx-auto px-6 md:px-12 max-w-6xl relative z-10 text-white">
            <span class="text-[#e5b842] text-xs font-bold uppercase tracking-[0.25em] block mb-3">The Heritage of
                Nepal</span>
            ...
            <p class="text-gray-300 text-sm md:text-base max-w-xl leading-relaxed font-light">
                Empowering local artisans by showcasing their unique handmade creations, preserving rich cultural
    ...
    <section class="container mx-auto px-6 md:px-12 max-w-6xl py-20 space-y-24">
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 gap-12 items-center">
            ...
            <div class="space-y-6">
                ...
                <p class="text-gray-600 text-sm md:text-base leading-relaxed">
                    For generations, the artisans of Nepal have crafted beautiful and meaningful works of art. From
                    intricate wood carvings to hand-woven textiles, each piece tells a unique story. At Hamro Koseli, we
                    are proud to share these stories with the world, connecting you with the artisans behind them.
                </p>
                <p class="text-gray-600 text-sm md:text-base leading-relaxed">
                    Every product is selected with great care, focusing on authentic materials, traditional skills, and
                    the preservation of Nepalese artistic lineage.
                </p>
            </div>
            ...
            <div class="relative group">
                <div
                    class="absolute -inset-1 bg-brand-primary/10 rounded-2xl blur-sm transition duration-500 group-hover:bg-brand-primary/20">
                </div>
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 gap-12 items-center">
            ...
            <div class="bg-[#E0D5C5] rounded-2xl p-8 md:p-10 shadow-md border border-gray-200/30 space-y-6">
                <h2 class="text-2xl md:text-3xl font-serif font-bold text-brand-dark leading-tight">The Artisan's Spirit
                </h2>
                <p class="text-gray-600 text-sm md:text-base leading-relaxed">
                    Every piece tells a story of dedication, passion, and skill. By supporting our artisans, you help
                    preserve these traditional crafts for future generations and support sustainable livelihoods.
                </p>
                <p class="text-gray-600 text-sm md:text-base leading-relaxed font-light">
                    Our network supports over 500 family-run workshops, enabling them to thrive while passing their
                    ancestral arts onto younger generations.
                </p>
            </div>
        </div>
    </section>
    ...
    <section class="container mx-auto px-6 md:px-12 max-w-6xl py-12">
        <div
            class="bg-[#E0D5C5] rounded-3xl p-8 md:p-12 shadow-lg border border-gray-200/30 grid grid-cols-1 lg:grid-cols-12 gap-12 items-center">
            ...
            <div class="lg:col-span-7 space-y-6">
                ...
                <p class="text-gray-600 text-sm md:text-base leading-relaxed">
                    By providing direct access to global markets and fair pricing, we support local communities and
                    promote the preservation of sustainable crafting traditions. We work side-by-side with master
                    makers.
                </p>
                ...
                <ul class="space-y-4 pt-2">
                    <li class="flex items-start gap-4">
                        <span
                            class="flex-shrink-0 w-6 h-6 rounded-full bg-[#fceae4] flex items-center justify-center text-brand-primary">
                            <i class="fa-solid fa-check text-sm font-bold"></i>
                        </span>
                        <p class="text-gray-700 text-sm font-medium">Direct-to-consumer access, maximizing artisan
                            income.</p>
                    </li>
                    <li class="flex items-start gap-4">
                        <span
                        ...
                        <p class="text-gray-700 text-sm font-medium">Digital literacy training and professional product
                            photography support.</p>
                    </li>
                    <li class="flex items-start gap-4">
                        <span
                            class="flex-shrink-0 w-6 h-6 rounded-full bg-[#fceae4] flex items-center justify-center text-brand-primary">
                        ...
                        <p class="text-gray-700 text-sm font-medium">Financial management resources for small-scale
                            makers.</p>
                    </li>
                </ul>
            </div>
    ...
    <section class="container mx-auto px-6 md:px-12 max-w-6xl py-20 text-center space-y-12">
        ...
        <div class="grid grid-cols-1 md:grid-cols-3 gap-8 md:gap-12">
            ...
            <div
                class="flex flex-col items-center space-y-4 p-4 transform hover:-translate-y-1 transition duration-300">
                ...
                <p class="text-gray-600 text-sm leading-relaxed max-w-xs mx-auto">
                    We verify every artisan and vendor to ensure only genuine, high-quality handcrafted products reach
                    your doorstep.
                </p>
            </div>
            ...
            <div
                ...
                <p class="text-gray-600 text-sm leading-relaxed max-w-xs mx-auto">
                    Artisans set their own prices. We believe in complete financial transparency, empowering small-scale
            ...
            <div
                class="flex flex-col items-center space-y-4 p-4 transform hover:-translate-y-1 transition duration-300">
                <div
                    class="w-16 h-16 rounded-full bg-amber-50 flex items-center justify-center text-amber-600 shadow-sm">
                    <i class="fa-solid fa-heart text-2xl"></i>
                </div>
                <h3 class="text-xl font-serif font-bold text-brand-dark">Sustainable Impact</h3>
                <p class="text-gray-600 text-sm leading-relaxed max-w-xs mx-auto">
                    We focus on eco-friendly materials and traditional methods that protect the environment and support
                    local economies.
                </p>
            </div>
        </div>
    ...
    <section class="container mx-auto px-6 md:px-12 max-w-6xl pb-24">
        <div class="relative rounded-3xl overflow-hidden bg-[#241e1c] py-16 px-8 text-center shadow-lg">
            ...
            <div class="absolute inset-0 bg-cover bg-center opacity-70"
                style="background-image: url('Assets/5th image.png');"></div>
            ...
            <div class="relative z-10 max-w-2xl mx-auto space-y-6">
                ...
                <p class="text-gray-300 text-sm md:text-base leading-relaxed">
                    Are you an artisan or maker looking to share your crafts with the world? We'd love to help you grow
                    your business and share your work globally.
                </p>
                <div class="pt-4">
                    <a href="become-seller.php"
                        class="inline-block bg-[#e5b842] hover:bg-[#d4a833] text-brand-dark font-semibold px-8 py-3 rounded-full shadow-md transition duration-300 transform hover:scale-105">
                        Become a Seller
                    </a>
                </div>
            </div>
